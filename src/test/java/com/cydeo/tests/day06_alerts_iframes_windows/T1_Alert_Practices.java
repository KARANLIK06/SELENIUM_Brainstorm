...
public class T1_Alert_Practices {
    ...
    public void alert_test1() throws InterruptedException {
        ...
        Assert.assertTrue(resultTxt.isDisplayed(),"Result text is not displayed");

        String expectedTxt ="You successfully clicked an alert";
        String actualTxt = resultTxt.getText();
