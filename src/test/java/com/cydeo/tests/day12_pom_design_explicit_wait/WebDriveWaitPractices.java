...
public class WebDriveWaitPractices {
    ...
    public void dynamic_load_7_test(){
        ...
        Assert.assertTrue(dynamicLoad7Page.doneMessage.isDisplayed(),"Message “Done” is not displayed");

        //4. Assert: Image is displayed.
        Assert.assertTrue(dynamicLoad7Page.spongeBobImage.isDisplayed(),"Image is not displayed");
    ...
    public void dynamic_load_1_test(){
        ...
        Assert.assertTrue(dynamicLoad1Page.errorMessage.isDisplayed(),"“Your password is invalid!” text is not displayed");
