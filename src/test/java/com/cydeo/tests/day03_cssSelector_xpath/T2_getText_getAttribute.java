...
public class T2_getText_getAttribute {
    public static void main(String[] args) {
        ...
        String expectedRemerberMeLabel="Remember me on this computer";
        String actualRemerberMeLabel=remerberMeLabel.getText();

        if (actualRemerberMeLabel.equals(expectedRemerberMeLabel)){
